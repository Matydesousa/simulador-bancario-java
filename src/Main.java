...
public class Main {
    public static void main(String[] args) {
        ...
        //printea la informacion de cada objeto usando toString
        ...
        CuentaBancaria cuenta002 = new CuentaBancaria(45211, 50000.0, "Juan Perez",
                "Caja de ahorro", "0170099220000012345679");
        banco.agregarCuenta(cuenta002);

        // Pasamos 20000 de la primera cuenta a la segunda.
        System.out.println("Saldo origen antes: " + cuenta001.consultarSaldo());
        System.out.println("Saldo destino antes: " + cuenta002.consultarSaldo());
        Boolean transferenciaRealizada = cuenta001.transferir(cuenta002, 20000.0);
        System.out.println("Transferencia realizada: " + transferenciaRealizada);
        System.out.println("Saldo origen despues: " + cuenta001.consultarSaldo());
        System.out.println("Saldo destino despues: " + cuenta002.consultarSaldo());

        //recarga efectivo en el cajero 2 y muestra el cambio
        cajero2.recargarEfectivo(30000.0);
        System.out.println(cajero2);
        //hace una busqueda de cajero dentro del banco por nro de serie
